...
export const metadata = { title: 'נוער בסיכון — המרכז לחוות דעת משפטיות' }
    ...
    <div className="pt-20">
      <div style={{ backgroundColor: '#0A1628' }} className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">נוער בסיכון</h1>
          <p className="text-white/65 text-lg">שירות מקצועי מותאם לצרכים שלכם.</p>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <p className="text-gray-600 leading-relaxed mb-8">
          המרכז לחוות דעת משפטיות מספק שירות נוער בסיכון ברמה הגבוהה ביותר, המבוסס על כלים אבחוניים מדעיים מוכרים וניסיון מצטבר של מאות תיקים.
        </p>
